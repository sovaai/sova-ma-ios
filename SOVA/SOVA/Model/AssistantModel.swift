...
struct Assitant: Codable{
    ...
    var messageList: [MessageList] {
        get{
            ...
            let message7 =  Message(assistantId: self.id, date: Date(), title: "Чтобы начать общаЧтобы начать общаться с виртуальным ассистеться с виртуальным ассистентом 🤖", sender: .user)
            ...
            let message12 =  Message(assistantId: self.id, date: Date(), title: "Чтобы начать общЧтобы начать общаться с виртуальным ассистеаться с виртуальным ассистентом 🤖", sender: .user)
